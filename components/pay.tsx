...
import { PointerWrapper } from "./magicui/pointer";
    ...
    <section className="relative py-4">
      <div className="max-w-screen-xl mx-auto text-gray-600 md:px-8">
        <div className="relative max-w-xl space-y-3 px-4 md:px-0">
          ...
          <TextAnimate className="dark:text-white text-gray-900 text-3xl font-semibold sm:text-4xl">
            Pay as you grow
          </TextAnimate>
            ...
            <div className="p-4 py-8 border-b md:p-8">
              <div className="justify-between flex">
                <div className="max-w-xs">
                  <span className="text-2xl dark:text-white text-gray-900 font-semibold sm:text-3xl">
                    {plan.name}
                  </span>
                  <p className="mt-3 sm:text-sm">{plan.desc}</p>
                </div>
                <div className="flex-none dark:text-white text-gray-900 text-2xl font-semibold sm:text-3xl">
                  <SparklesText
              ...
              <PointerWrapper>
                <div className="mt-4 px-3 py-3 rounded-lg w-full text-center font-semibold text-sm duration-150 text-white bg-indigo-600 hover:bg-indigo-500 active:bg-indigo-700">
                  Get started
                </div>
              </PointerWrapper>
            </div>
            <ul className="p-4 space-y-3 sm:grid sm:grid-cols-2 md:block md:p-8 lg:grid">
              <div className="pb-2 col-span-2 dark:text-white text-gray-900 font-medium">
                <p>Features</p>
              </div>
